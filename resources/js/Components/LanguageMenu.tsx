...
export default function LanguageMenu (): JSX.Element {
  ...
  return (
    <div className="select language-menu items-end flex flex-no-wrap justify-end">
      ...
      <Select.Content className="content bg-white p-2 fixed left-0 sm:left-auto right-0 sm:right-5 top-15 sm:top-15 w-full sm:w-auto sm:rounded-10 py-2.5 px-2 sm:px-2.5 border-t sm:border-0 border-grey-input">
