...
export default function AccountBlock (props: {
  ...
  const { title, showContent, showEdit, onSave, isPasswordBlock, editTranslation, saveTranslation, generatePassword, testId } = props
  ...
  return (
    <div className={'account-block py-7 px-5 rounded-10 max-w-[55rem] md:mr-8 mx-4 md:ml-0 mb-7'} data-testid={testId}>
        ...
        ? <>
          { showContent }
            <div className={'flex flex-row justify-end'}>
              <button data-testid='account_edit_button' type={'button'} onClick={() => setOpen(open => !open)}
        ...
        : <>
            ...
            <div className={`flex flex-col sm:flex-row ${isPasswordBlock ? 'justify-between' : 'justify-end'}`}>
              ...
              <div className={'flex self-end sm:self-auto'}>
                ...
                <button data-testid='account_save_button' type={'button'} onClick={onSaveClick}
